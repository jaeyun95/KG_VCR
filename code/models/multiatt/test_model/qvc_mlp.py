...
class AttentionQA(Model):
    def __init__(self,
        ...
        self.node_pool = torch.nn.AdaptiveAvgPool2d((4,1024))
    ...
    def vc_compress(self, visual_concept, question):
        """
        :param node: Thing that will get embed and turned into [batch_size, ..leading_dims.., L, word_dim]
        :param visual_concept: [batch_size, ..leading_dims.., L]
        :param question: [batch_size, max_num_objs_per_batch, obj_dim]
        ...
        return self.node_pool(padd_pre_node_rep)
        #return padd_pre_node_rep
    ...
    def forward(self,
        ...
        node_rep = self.vc_compress(visual_concept, question)
        ...
        final_material_rep = torch.cat((pooled_rep,node_rep),-1)
        #print(final_material_rep.shape)
