...
class AttentionQA(Model):
    def __init__(self,
        ...
        #add gcn model here
        self.gcn = GCN(nfeat = 768 ,nhid = 16 ,nclass =  512,dropout = 0.5)
    ...
    def _collect_vc_reps(self, object_reps, activity_reps,secne_reps):
        """
        Collect node representations and make gcn's input 
        :param vcr_reps: [batch_size, ..leading_dims.., L]
        :param question_reps: [batch_size, ..leading_dims.., L]
        :param word_reps: [batch_size, ..leading_dims.., L]
        :param adj: [batch_size, max_num_objs_per_batch, obj_dim]
        :return:
        """
    #add processing gcn argument
    def _collect_node_reps(self, vc_reps, question_reps, word_reps, adj):
        """
        Collect node representations and make gcn's input 
        :param vcr_reps: [batch_size, ..leading_dims.., L]
        :param question_reps: [batch_size, ..leading_dims.., L]
    ...
    def forward(self,
                ...
                keyword: List[Dict[str, Any]] = None,
                label: torch.LongTensor = None,
                question_keyword: List[Dict[str, Any]] = None, # add here 
                answer_keyword: List[Dict[str, Any]] = None) -> Dict[str, torch.Tensor]: # Optional, which item is valid  # add here 
        """ 
        ...
        :param question_keyword: Optional, which item is valid
        :param answer_keyword, which item is valid
        :return: shit
        """
        #print('aaaaaaaaaaaaa : ',answer_keyword)
