...
class VCR(Dataset):
    def __init__(self, split, mode, only_use_relevant_dets=True, add_image_as_a_box=True, embs_to_load='bert_da',
        ...
        #print('@@@@@@@@@@@@@ add_image_as_a_box : ',self.add_image_as_a_box)
        ...
        ########################################### node information file!  train_scene_version
        #with open(os.path.join(VCR_ANNOTS_DIR, '/media/ailab/songyoungtak/vcr_new/new/add_keyword/{}_answer_top_50_node.jsonl'.format(split)), 'r') as f:
        #    self.node = [json.loads(s) for s in f]
        ########################################### word information file!
        #with open(os.path.join(VCR_ANNOTS_DIR, '/media/ailab/songyoungtak/vcr_new/new/add_keyword/0814_word_final_list.jsonl'), 'r') as f:
        #    self.word = [json.loads(s) for s in f]
        ...
        #print('@@@@@@@@@@ coco_object : ',self.coco_objects)
        self.coco_obj_to_ind = {o: i for i, o in enumerate(self.coco_objects)}
        #print('@@@@@@@@@@ coco_obj_to_ind : ',self.coco_obj_to_ind)

        self.embs_to_load = embs_to_load
        #print('@@@@@@@@@ embs_to_load : ',self.embs_to_load) train_scene_version
        ...
        #print('@@@@@@@@@ h5fn : ',self.h5fn) train_scene_version_answer_top_50_node
        #train_scene_version_answer_top_50_node train_scene_version_answer_top_50_node.h5
    ...
    def splits(cls, **kwargs):
        ...
        #print('cccccccccccccccc : ',kwargs_copy,', type is : ',type(kwargs_copy))
    ...
    def _get_dets_to_use(self, item):
        ...
        #print('@@@@@@@@@@@@ old_det_to_new_ind : ',old_det_to_new_ind)
    ...
    def __getitem__(self, index):
        ...
        #instance_dict['node_tags'] = ListField(node_tags)
        ...
        instance_dict['metadata'] = MetadataField({'annot_id': item['annot_id'], 'ind': index, 'movie': item['movie'],
                                                   'img_fn': item['img_fn']})
        ##add here!!
        #if item['annot_id'] != node['annot_id']:
        #   raise ValueError("annot_id is different!!")
        #instance_dict['graph_data'] = MetadataField({'adj': node['adj']})
