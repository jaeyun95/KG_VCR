...
class SimpleDetector(nn.Module):
    ...
    def forward(self,
        ...
        #print('@@@@@@@@@@@@ box_mask : ',box_mask)
        #print('@@@@@@@@@@@@ box_mask.shape : ',box_mask.shape)
        #print('@@@@@@@@@box_inds : ',box_inds)
        #print('@@@@@@@@@box_inds0 : ',box_inds[:,0])
        #print('@@@@@@@@@box_inds0None : ',box_inds[:,0,None])
        ...
        #print('@@@@@@@@@@@@ box_mask.sum(1).tolist() : ',box_mask.sum(1).tolist())
        #print('@@@@@@@@@ box_mask : ',box_mask)
        #print('@@@@@@@@@ box_mask.sum(1) : ',box_mask.sum(1))
